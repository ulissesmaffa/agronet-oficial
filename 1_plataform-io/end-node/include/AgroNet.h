...
void loadRoutes(std::list<loraEntity*> *routes, loraEntity *self,loraEntity* *main_route){
  ...
  // rotas do entidade 2 end-node intermediario
  aux = new loraEntity;
  aux->personalId = 0xFF;
  aux->ADDL = 0xFF;
  aux->ADDH = 0x00;
  aux->CHAN = 0x08;
  aux->entityType = GATEWAY;
  aux->direction = FORWARD;
  ...
  // rotas entidade 3 end-node final
  // aux = new loraEntity;
  // aux->personalId = 0x02;
  // aux->ADDL = 0x02;
  // aux->ADDH = 0x00;
